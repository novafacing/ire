...
mod test {
    ...
    fn test_AARCH64BE() {
        const AARCH64BE: &str =
            include_str!("../../Processors/AARCH64/data/languages/AARCH64BE.sla");
    ...
    #[test]
    fn test_data_be_64() {
        const data_be_64: &str =
            include_str!("../../Processors/DATA/data/languages/data-be-64.sla");
        parse(data_be_64).expect("Failed to parse data-be-64 sla");
    }
    #[test]
    fn test_data_le_64() {
        const data_le_64: &str =
            include_str!("../../Processors/DATA/data/languages/data-le-64.sla");
    ...
    #[test]
    fn test_mips32R6be() {
        const mips32R6be: &str =
            include_str!("../../Processors/MIPS/data/languages/mips32R6be.sla");
        parse(mips32R6be).expect("Failed to parse mips32R6be sla");
    }
    #[test]
    fn test_mips32R6le() {
        const mips32R6le: &str =
            include_str!("../../Processors/MIPS/data/languages/mips32R6le.sla");
    ...
    fn test_ppc_32_be() {
        const ppc_32_be: &str =
            include_str!("../../Processors/PowerPC/data/languages/ppc_32_be.sla");
    ...
    fn test_ppc_32_le() {
        const ppc_32_le: &str =
            include_str!("../../Processors/PowerPC/data/languages/ppc_32_le.sla");
    ...
    fn test_ppc_64_be() {
        const ppc_64_be: &str =
            include_str!("../../Processors/PowerPC/data/languages/ppc_64_be.sla");
    ...
    fn test_ppc_64_le() {
        const ppc_64_le: &str =
            include_str!("../../Processors/PowerPC/data/languages/ppc_64_le.sla");
    ...
    #[test]
    fn test_SparcV9_32() {
        const SparcV9_32: &str =
            include_str!("../../Processors/Sparc/data/languages/SparcV9_32.sla");
        parse(SparcV9_32).expect("Failed to parse SparcV9_32 sla");
    }
    #[test]
    fn test_SparcV9_64() {
        const SparcV9_64: &str =
            include_str!("../../Processors/Sparc/data/languages/SparcV9_64.sla");
